...
<div class="turbosmtp-setup-card">
    ...
    <form action="<?php echo admin_url( 'admin-post.php' ); ?>" method="post" class="tswp-login-form tswp-migration-form">
        ...
        <p><?php echo sprintf( esc_html__( 'Hello %s, Your API Keys are required to continue. Please enter your existing API keys or generate a new pair of keys.', 'turbosmtp' ), $auth_options["op_ts_email"] ); ?></p>
        ...
        <fieldset>
            ...
            <div class="tswp-text-center">
                ...
                <button type="submit" name="save_api_keys" id="save_api_keys" class="button button-primary">
                    <?php esc_html_e( 'Connect to turboSMTP', 'turbosmtp' ); ?>
                </button>
        ...
        <div class="tswp-or-separator">
            <div></div>
            <span><?php esc_html_e( 'Or', 'turbosmtp' ); ?></span>
            <div></div>
        </div>
        <p><?php echo esc_html_e( 'Clicking the following button will automatically generate a new set of API keys and log you into your turboSMTP account.', 'turbosmtp' ); ?></p>

        <p class="tswp-text-center">
            <button data-nonce="<?php echo esc_attr(wp_create_nonce( 'turbosmtp_generate_api_keys' )); ?>" type="button" id="generate_api_keys" class="button button-primary">
                <?php esc_html_e( 'Generate API Keys and connect', 'turbosmtp' ); ?>
            </button>
        </p>
